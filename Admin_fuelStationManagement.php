...
<button class="btn btn-primary"><a href="Admin_FuelStationRegistration.php" class="text-light">Click Here</a></button><p>
 	...
 	while($row=mysqli_fetch_assoc($ret))
 	{
        ...
        $Owner_Mobile_No=$row['Owner_Mobile_No'];
 		...
 		echo'<tr>
              ...
              <td><button class="btn btn-danger" name="btnDelete"><a href="Admin_fuelStationManagement.php?deleteid='.$Registration_No.'" class="text-light">Delete</a></button></td>
             </tr>';
 	}
 }
?>
