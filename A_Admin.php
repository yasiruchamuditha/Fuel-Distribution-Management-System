            ...
            <!--User Management-->
               <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="A_User_Management.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
            ...
            <!--Fuel Station Management-->
               <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="A_Fuel_Station_Management.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
            ...
            <!--Fuel Supplier Management-->
               <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="A_Supplier_Management.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="A_Fuel_Price_Management.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
               ...
               <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="A_Fuel_Status_Management.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="A_Vehicle_Management.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
               ...
               <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="A_Vehicle_Token_Management.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="A_Non_Vehicle_Management.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
               ...
               <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="A_Non_Vehicle_Token_Management.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
