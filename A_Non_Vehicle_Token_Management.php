...
if(isset($_GET['deleteid']))
{
    ...
    $sql="Delete from token_instrument where Registration_No='$deleteid' ";
...
<div class="container"> <h1>Admin Panel - Non Vehicle Token Management </h1></div>
...
<p style="font-size: 20px; font-weight: bold;margin-top: 20px;">Instrument Details</p>
<table class="table">
<thead> 
    <tr  class="table-info">
 ...
 if ($ret) 
 {
    while($row=mysqli_fetch_assoc($ret))
    {
        ...
        echo'<tr>
              ...
              <td>'.$Mobile_No.'</td>
              <td>'.$FuelType.'</td>
              <td><button class="btn btn-danger" name="btnDelete"><a href="Admin_Non_Vehicle_Token_Management.php?deleteid='.$Registration_No.'" class="text-light">Delete</a></button></td>
             </tr>';
    }
 }
?>
