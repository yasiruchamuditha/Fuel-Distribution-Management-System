        ...
        <form action="#" method="post" name="frmlogin" onsubmit="return validateForm()">
         ...
         <div class="field create-password">
            ...
            <div class="my-4" id="divm5">
             <label for="ForgottenPassword" class="form-label" ><a href="M_Forgotten_Password.php" target="_blank" style="color: white;">Forgotten Password ? </a></label><br>
         
              <label for="Signup" class="form-label" ><a href="M_User_SignUp.php" target="_blank" style="color: white;">Don't Have Account ? Signup </a></label><br>
            </div>  
        </form>
    </div>
   </div>
