...
if(isset($_POST['btnDelete']))
{
	...
	$sql="DELETE FROM supplier_registration WHERE Registration_No=? ";
...
<head>
	<meta charset="utf-8">
    <title>Admin Panel- Fuel Supplier Management</title>
...
<div class="container"> 
<h1>Admin Panel -Fuel Supplier Management </h1>
<p class="header">Add New Supplier Profiles - <button class="btn btn-primary "><a href="A_Supplier_Registration.php" class="text-light">Click Here</a></button></p>
        ...
        <?php
            ...
            if ($ret) 
            {
                while($row=mysqli_fetch_assoc($ret))
                {
                    ...
                    $Director_Name = htmlspecialchars($row['Director_Name']);
