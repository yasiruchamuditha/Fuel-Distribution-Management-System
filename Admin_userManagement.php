...
<p class="header">Add New User Profiles - <button class="btn btn-primary "><a href="Admin_UserRegistration.php" class="text-light">Click Here</a></button></p>
 ...
 if ($ret) 
 {
 	while($row=mysqli_fetch_assoc($ret))
 	{
 		...
 		echo'<tr>
              ...
              <td>'.$Email.'</td>
              <td>'.$Password.'</td>
              <td><button class="btn btn-danger" name="btnDelete"><a href="Admin_userManagement.php?deleteid='.$Email.'" class="text-light">Delete</a></button></td>
             </tr>';
 	}
 }
?>
