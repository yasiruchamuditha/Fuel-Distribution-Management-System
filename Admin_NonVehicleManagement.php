...
<p class="header">Register New Instrument - <button class="btn btn-primary my-2"><a href="Admin_NonVehicleRegistration.php" class="text-light">Click Here</a></button></p>	
 ...
 if ($ret) 
 {
 	while($row=mysqli_fetch_assoc($ret))
 	{
 		...
 		echo'<tr>
              ...
              <td>'.$Fuel_Capacity.'</td>
              <td>'.$Fuel_Type.'</td>
              <td><button class="btn btn-danger" name="btnDelete"><a href="Admin_NonVehicleManagement.php?deleteid='.$Registration_No.'" class="text-light">Delete</a></button></td>
             </tr>';
 	}
 }
?>
