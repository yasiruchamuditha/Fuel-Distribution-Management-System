            ...
            <div class="row">
               ...
               <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="Qr_Verification.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
            ...
            <!--Fuel status Management-->
               <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="fuelStatus.php" class="btn btn-primary py-md-3 px-md-5 mt-2">update Now</a>
                    </div>
                </div>
                <!--End -->
       </div>
            ...
            <!--Fuel Station Management-->
               <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="fuelstationregistration.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
               ...
               <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="Fuel_Station_Feedback.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Check Now</a>
                    </div>
                </div>
                <!--End -->
